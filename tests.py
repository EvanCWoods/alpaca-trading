...
plt.plot(close[20 :HISTORY], label='Closing Prices', c="#000000")
plt.plot(bollinger_up[20 :HISTORY], label='Bollinger Up', c='#33C7FF', linewidth=1)
plt.plot(bollinger_down[20 :HISTORY], label='Bollinger Down', c='#33C7FF', linewidth=1)
plt.plot(get_sma(close[20 :HISTORY], RATE), label='SMA20', c='#808080', linewidth=1)
plt.scatter(buys[20 :HISTORY], buy_price[20 :HISTORY], marker="^", c="g", label="buys, spot price") # add ^ smbols when on buy signal 
plt.scatter(sells[20 :HISTORY], sell_price[20 :HISTORY], marker="v", c="r", label="sells, spot price") # add v smbols when on sell signal 
plt.legend()
